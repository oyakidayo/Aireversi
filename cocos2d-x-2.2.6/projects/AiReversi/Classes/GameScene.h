...
public:
   ...
   int showGameevalLabel(void);
    ...
    void evalFaceNormal(void);
    void evalFaceWin(void);
    void evalFaceLose(void);
    void showGameScene(void);
    void evalFaceMinorWin(void);
    void evalFaceMinorLose(void);
    void evalFaceMajorWin(void);
    void evalFaceMajorLose(void);
