...
void Option::makeReturn(void)
{
   ...
   CCMenuItemImage* returnItem=CCMenuItemImage::create("ok_on.png",
                                                      "ok_off.png",
                                                      this,menu_selector(Option::tapReturn));
   returnItem->setPosition(ccp(winSize.width*0.5f,winSize.height*0.05f));
